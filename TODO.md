...
- [x] ~~Test the database connection and data persistence after deploying~~
...
- [x] ~~Carousel for commission: a user should be able to select extra commission from a dropdown list. both in the edit modal and in the today part~~
- [x] ~~improve todays recognizability~~
- [x] ~~user button with login/logout and dark/light mode~~